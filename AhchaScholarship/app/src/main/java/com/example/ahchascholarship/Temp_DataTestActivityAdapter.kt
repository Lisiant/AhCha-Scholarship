...
: RecyclerView.Adapter<Temp_DataTestActivityAdapter.MyViewHolder>()
{
	...
	override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
		...
		holder.binding.e3 .text = "운영기관구분: ".plus(items[position].운영기관구분)
		holder.binding.e4 .text = "상품구분: ".plus(items[position].상품구분)
		holder.binding.e5 .text = "학자금유형구분: ".plus(items[position].학자금유형구분)
		holder.binding.e6 .text = "대학구분: ".plus(items[position].대학구분)
		holder.binding.e7 .text = "학년구분: ".plus(items[position].학년구분)
		holder.binding.e8 .text = "학과구분: ".plus(items[position].학과구분)
		...
		holder.binding.e14.text = "신청기간: ".plus(items[position].신청기간)
		holder.binding.e15.text = "선발방법: ".plus(items[position].선발방법)
		holder.binding.e16.text = "선발인원: ".plus(items[position].선발인원)
		holder.binding.e17.text = "자격제한: ".plus(items[position].자격제한)
		holder.binding.e18.text = "추천필요여부: ".plus(items[position].추천필요여부)
		holder.binding.e19.text = "제출서류: ".plus(items[position].제출서류)
	}
